Politique de confidentialité de ALD Consulting 

La présente Politique de confidentialité décrit la façon dont vos informations personnelles sont recueillies, utilisées et partagées lorsque vous vous rendez sur https://ald-consulting.fr (le « Site ») ou que vous y effectuez un achat.
...
NOUS CONTACTER
Pour en savoir plus sur nos pratiques de confidentialité, si vous avez des questions ou si vous souhaitez déposer une réclamation, veuillez nous contacter par e-mail à contact@ald-consulting.fr, ou par courrier à l'adresse suivante :

 1 rue des 3 pigeons, Toulouse, 31200, France
